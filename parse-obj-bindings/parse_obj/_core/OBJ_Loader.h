...
namespace objl
{
    ...
    struct Mesh
    {
        ...
        // Variable Set Constructor
        Mesh(std::vector<Vertex>& _Vertices, std::vector<unsigned int>& _Indices, std::vector<Vector3>& _Positions)
        {
            Vertices = _Vertices;
            Indices = _Indices;
    ...
    public:
        ...
        bool LoadFile(std::string Path)
        {
            ...
            std::vector<Vector3> Positions;
            std::vector<Vector3> PositionsObj;
            ...
            while (std::getline(file, curline))
            {
                ...
                if (algorithm::firstToken(curline) == "o" || algorithm::firstToken(curline) == "g" || curline[0] == 'g')
                {
                    ...
                    else
                    {
                        ...
                        {
                            // Create Mesh
                            tempMesh = Mesh(Vertices, Indices, PositionsObj);
