# This setup is taken from https://github.com/sizmailov/pybind11-project-example
...
setup(
    ...
    description='pybind11 project for .obj parsing',
    long_description=open("README.rst").read(),
    ext_modules=[CMakeExtension('parse_urdf/_core')],
